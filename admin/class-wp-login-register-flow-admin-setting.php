...
class WPLRFAdminSettings {
	...
	*/
	function wplrf_setting_admin_menu() {
		...
		add_menu_page('WPLRF','WP Login Register','manage_options','wplrf_settings_page',array($this, 'wplrf_settings_page' ),'dashicons-groups');
	...
	*/
	function wplrf_settings_page() {
		...
		if ( current_user_can('manage_options') ) {
	        ...
	        if (isset($_POST['wplrf-form-settings'])) {
	        	...
	        	if ( ! isset( $_POST['wplrf_setting_field_nonce'] ) || ! wp_verify_nonce( $_POST['wplrf_setting_field_nonce'], 'wplrf_setting_action_nonce' ) ) {
	            	...
	            	# show admin bar options
	            	if (isset($_POST['wplrf-show-admin-bar'])) {
		                $show_admin = sanitize_text_field($_POST['wplrf-show-admin-bar']);
		                $show_admin = !empty($show_admin) ? $show_admin : "no";
		                update_option('wplrf-show-admin-bar', $show_admin);				           
	            	}
        ...
        # get value of admin bar option
        $hide_admin_bar = esc_attr(get_option('wplrf-show-admin-bar'));
		?>
		<!-- WPLRF Settings -->
		<div class="wrap">
								...
								<!-- Show Account Icon Section -->
                                 ...
                                 <tr valign="top">
                                  ...
                                  <?php if(!empty($show_icon) && $show_icon == "yes"){?>
	                                  ...
	                                  <table>
			                                  <tr valign="top">
			                                  <th scope="row"><label for="wplrf-account-user-role"><?php _e('Default Role for Register User &nbsp;&nbsp;&nbsp; ','wplrf'); ?></label></th>
			                                  <td>
                                 	 ...
                                 	 <table>
		                                 <tr valign="top">
		                                  <th scope="row"><label for="wplrf-show-admin-bar"><?php _e('Hide Admin Bar &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;','wplrf'); ?></label></th>
		                                  <td>	
		                                  		<?php $hide_yes = ($hide_admin_bar == "yes") ? 'checked="checked"' : "";?>
		                                  		<?php $hide_no = ($hide_admin_bar == "no") ? 'checked="checked"' : "";?>
		                                  		<input type="radio" name="wplrf-show-admin-bar" id="show-admin-bar-yes" value="yes" <?php echo $hide_yes; ?> ><label for="show-admin-bar-yes"><?php _e('Yes','wplrf'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
		                                  		<input type="radio" name="wplrf-show-admin-bar" id="show-admin-bar-no" value="no" <?php echo $hide_no; ?>><label for="show-admin-bar-no"><?php _e('No','wplrf'); ?></label>
		                                    </td>
		                                  </tr>
                                   		</table>
                                   		 <!-- Show Admin Bar section end -->
