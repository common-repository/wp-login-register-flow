...
{
	# verify ajax nonce
	check_ajax_referer( 'wplrf_ajax_nonce', 'wplrf_security' );
	...
	if(isset($_POST['wplrf_change_new_password']) && isset($_POST['wplrf_change_confirm_password']) && isset($_POST['wplrf_get_user_id']) ) 
	{
      	...
      	else if($new_password != $confirm_password)
	    {
      	...
      	{ 
			...
			{
				# set cookie and current user after password change
